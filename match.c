 ...
 *
 * This function takes a struct `line` containing line contents and line number,
 * and a struct `meta` containing all allocated memory. It searches for a match
 * between the opcode and text and returns a pointer to the corresponding function.
 *
